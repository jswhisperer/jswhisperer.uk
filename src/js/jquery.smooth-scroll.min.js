  ...
  t.fn.extend({
        ...
        this.unbind("click.smoothscroll").bind(
          ...
          function (l) {
            var o = t(this),
              ...
              p =
                r.scrollTarget ||
                t.smoothScroll.filterPath(this.pathname) === n,
              m = e(this.hash);
    ...
    (t.smoothScroll = function (e, o) {
      ...
      var s,
        ...
        d = {};
      "number" == typeof e
        ? ((s = t.extend({ link: null }, t.fn.smoothScroll.defaults, l)),
          (r = e))
        : (s = t.extend({ link: null }, t.fn.smoothScroll.defaults, e || {}, l))
            .scrollElement &&
          ((f = "position"),
        ...
        s.scrollElement
          ? ((n = s.scrollElement),
            /^(?:HTML|BODY)$/.test(n[0].nodeName) || (a = n[h]()))
        ...
        (r =
          "number" == typeof e
            ? e
            : o ||
              (t(s.scrollTarget)[f]() && t(s.scrollTarget)[f]()[s.direction]) ||
              0),
        (u[h] = r + a + s.offset),
        "auto" === (i = s.speed) &&
          (0 > (c = u[h] - n.scrollTop()) && (c *= -1),
          (i = c / s.autoCoefficient)),
        (d = {
          duration: i,
          easing: s.easing,
          complete: function () {
