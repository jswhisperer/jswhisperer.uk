...
;(function (a, b) {
			...
			j.removeChild(p),
				...
				f(function () {
					...
					!u ||
						...
						d.appendChild(p),
						(p.innerHTML =
							"<table><tr><td style='" + t + "0;display:none'></td><td>t</td></tr></table>"),
						...
						a.getComputedStyle &&
							...
							(b.reliableMarginRight =
								(parseInt((a.getComputedStyle(l, null) || { marginRight: 0 }).marginRight, 10) ||
									0) === 0)),
						...
						a.getComputedStyle &&
							((p.style.marginTop = '1%'),
							(b.pixelMargin =
								(a.getComputedStyle(p, null) || { marginTop: 0 }).marginTop !== '1%')),
	...
	f.ajaxSetup({
		...
		f.ajaxPrefilter('json jsonp', function (b, c, d) {
			var e =
				typeof b.data == 'string' && /^application\/x\-www\-form\-urlencoded/.test(b.contentType)
			if (
				b.dataTypes[0] === 'jsonp' ||
