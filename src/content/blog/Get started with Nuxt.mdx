...
category: Category 1
description: >-
  This is my goto stack Nuxt.js which is server side rendered framework around
  vue. It plays on Next.js from the React world. At the end you’ll have a super
  performant website to build off of.
...
<Prism lang='js' code={`npx create-nuxt-app <project-name>`} />
