...
You can test that your page will be rich result ready aka SEO-tastic with [this tool](https://search.google.com/test/rich-results) [you can find more example schema’s for things other than Articles](https://developers.google.com/search/docs/data-types/article)
