	...
	t.fn.extend({
		...
		(t.smoothScroll = function (e, l) {
			...
			'number' == typeof e
				...
				: ((n = t.extend({ link: null }, t.fn.smoothScroll.defaults, e || {}, o)),
				  n.scrollElement &&
						((f = 'position'),
				...
				n.scrollElement
					? ((s = n.scrollElement), /^(?:HTML|BODY)$/.test(s[0].nodeName) || (a = s[u]()))
					: (s = t('html, body').firstScrollable(n.direction)),
				n.beforeScroll.call(s, n),
				(r =
					'number' == typeof e
						? e
						: l || (t(n.scrollTarget)[f]() && t(n.scrollTarget)[f]()[n.direction]) || 0),
				(h[u] = r + a + n.offset),
				(i = n.speed),
				'auto' === i &&
					((c = h[u] - s.scrollTop()), 0 > c && (c *= -1), (i = c / n.autoCoefficient)),
				(d = {
					duration: i,
					easing: n.easing,
					complete: function () {
